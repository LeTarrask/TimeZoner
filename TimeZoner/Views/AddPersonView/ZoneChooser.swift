...
struct ZoneChooser: View {
    @Environment(\.presentationMode) var presentationMode
    
    @Binding var TZid: String
...
//    #endif
    ...
    var searchResults: [String] {
        if searchText.isEmpty {
            ...
            return TZones.filter { $0.contains(searchText) }
        }
    }
}

struct ZoneChooser_Previews: PreviewProvider {
    static var previews: some View {
        ZoneChooser(TZid: .constant("none chosen"))
    }
}
